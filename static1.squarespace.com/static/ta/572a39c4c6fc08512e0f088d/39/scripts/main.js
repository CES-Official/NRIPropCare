...
var _modulesUtilityJs = require('./modules/utility.js');

/**
 * Navscripts
 */

var _modulesNavJs = require('./modules/nav.js');

/**
 * HomeBanner
 */

var _modulesHomeBannerJs = require('./modules/home-banner.js');

/**
 * Banner
 */

var _modulesResizeBannerJs = require('./modules/resize-banner.js');

/**
 * Accordion
 */

var _modulesAccordionJs = require('./modules/accordion.js');

/**
 * ScrollAnimations
 */

var _modulesScrollAnimationsJs = require('./modules/scroll-animations.js');
 ...
 */
var bxSlider = require('bxslider');$(document).ready(function () {
  /**
  * Initialize navigation scripts
  */
  (0, _modulesNavJs.navScripts)();
  /**
  * Initialize LoadAllImages subscription
  */
  _modulesUtilityJs.Utility.loadAllImages();
  /**
  * Initialize Banner subscriptions
  */
  _modulesResizeBannerJs.ResizeBanner.init();
  /**
  * Initialize HomeBanner subscriptions
  */
  _modulesHomeBannerJs.HomeBanner.init();
  /**
  * Initialize smooth subscription
  */
  _modulesUtilityJs.Utility.smoothScroll();
  /**
  * Initialize accordion subscriptions
  */
  _modulesAccordionJs.Accordion.accordionWatch();
  /**
  * Initialize scroll animations
  */
  _modulesScrollAnimationsJs.ScrollAnimations.init();
});
...
},{"./modules/accordion.js":4,"./modules/home-banner.js":5,"./modules/nav.js":6,"./modules/resize-banner.js":7,"./modules/scroll-animations.js":8,"./modules/utility.js":9,"bxslider":1,"jquery":2}],4:[function(require,module,exports){
// Import Utility
'use strict';
...
var Accordion = {
   ...
   * @memberof Accordion
   */
  accordionWatch: function accordionWatch() {
    ...
    function open_accordion_section(el) {
      ...
      _utilityJs.Utility.corticaFireResize();
    }
...
},{"./utility.js":9}],5:[function(require,module,exports){
/**
 * Require jquery
 */
'use strict';
 ...
 * Require bxSlider
 */
var bxSlider = require('bxslider');var HomeBanner = {
    ...
    init: function init() {
        ...
        var homeBanner = $('#home-banner').bxSlider({
            ...
            onSlideAfter: function onSlideAfter(el) {
                reloadBannerImages();
            }
...
},{"./utility.js":9,"bxslider":1,"jquery":2}],6:[function(require,module,exports){
/**
 * Require jquery
 */
'use strict';
...
function stickyNav() {
    ...
    function removeSticky() {
        ...
        $.when(rmvStickyClass()).then(resetAnimation());
    }
...
window.jQuery = require('jquery');
window.$ = window.jQuery;var ResizeBanner = {
  ...
  init: function init() {
    ...
    _utilityJs.Utility.detectMobile();
   ...
   * @memberof ResizeBanner
   */
  resizeTheBanner: function resizeTheBanner() {
    _utilityJs.Utility.resizeElement('#banner-area.banner-area-home', window, function () {
      _utilityJs.Utility.loadAllImages();
    });
    _utilityJs.Utility.resizeElement('ul#home-banner .home-banner-slide', window, function () {
      _utilityJs.Utility.loadAllImages();
    });
  },
   ...
   * @memberof ResizeBanner
   */
  setBannerElHeight: function setBannerElHeight($elOne, $elTwo, height) {
    ...
    $.when(addCssHeight()).then(function () {
      _utilityJs.Utility.loadAllImages();
    });
  },
   ...
   * @memberof ResizeBanner
   */
  largeScreenHeight: function largeScreenHeight() {
   ...
   * @memberof ResizeBanner
   */
  smallScreenHeight: function smallScreenHeight() {
   ...
   * @memberof ResizeBanner
   */
  setTheBannerHeight: function setTheBannerHeight() {
   ...
   * @memberof ResizeBanner
   */
  bannerSizes: function bannerSizes() {
    ...
    _utilityJs.Utility.resizeElement('#banner-area .bx-viewport', '#banner-area.banner-area-home', function () {}); //resize the .bx-viewport only on load. the .bx-viewport causes sizing problems otherwise.
...
exports.ResizeBanner = ResizeBanner;

},{"./utility.js":9,"jquery":2}],8:[function(require,module,exports){
/*******************************************
 * Requires
*******************************************/
/**
...
var ScrollAnimations = {
   ...
   */
  animateOnScroll: function animateOnScroll(elString, offsetHeight, animationString) {
   ...
   * class to toggle.
   */
  checkOffset: function checkOffset(el, thresholdEl, classNameString) {
...
var Utility = {
   ...
   * });
   *
   * @method onElementHeightChange
   * @see http://stackoverflow.com/questions/14866775/detect-document-height-change
   * @memberof Utility
   */
  onElementHeightChange: function onElementHeightChange(elm, callback) {
  ...
  /**
   * Resizes an element to the height of another
   * @method resizeElement
   * @memberof ResizeBanner
   */
  resizeElement: function resizeElement(elOne, elTwo, callback) {
    // Cache parameters
    var $elOne = $(elOne);
    var $elTwo = $(elTwo);
    ...
    if ($elOne.length > 0) {
      $.when($elOne.css({
        height: $elTwo.innerHeight() // Set height of elOne to elTwo
      })).then(callback);
    } else {
      return; // element doesn't exist
    }
  ...
  /**
   * Detects if element is a mobile device
   *
   * @method onElementHeightChange
   * @see http://stackoverflow.com/questions/14866775/detect-document-height-change
   * @memberof Utility
